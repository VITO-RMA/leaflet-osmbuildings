const LeafletOSMBuildings = (function() {
...
class LeafletOSMBuildings extends L.Layer {
  constructor(map) {
    super(map);
  ...
  onMoveEnd(e) {
    if (this.noMoveEnd) {
      // moveend is also fired after zoom
  ...
  onZoom(e) {
    ...
    Layers.container.style.transform =
...
LeafletOSMBuildings.VERSION = VERSION;
LeafletOSMBuildings.ATTRIBUTION = ATTRIBUTION;

 return LeafletOSMBuildings;
}());